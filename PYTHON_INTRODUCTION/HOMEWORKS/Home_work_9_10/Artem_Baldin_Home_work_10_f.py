...
"""
2
Напишите функция is_prime, которая принимает \
1 аргумент (число) и возвращает True, если число \
простое, иначе False
Простое число - это число, которое делится без \
...
for i in range(100):
    if is_prime(digit_to_check) is True:
...
"""
3
Напишите функцию, которая принимает 1 аргумент (строка)\
 и выполняет следующие действия на каждую из букв строки:
i - инкремент (+1)
d - дикремент (-1)
